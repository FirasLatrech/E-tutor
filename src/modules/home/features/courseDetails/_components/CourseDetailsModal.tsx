...
const CustomModal = ({ title, defaultOpen, courseDetails }: Props) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      ...
      <DialogContent className="sm:max-w-[525px] h-[700px]   overflow-auto">
        <DialogHeader>
        ...
        <>
          <div className="flex items-center justify-between p-4 ">
            ...
            {/* discounrt  */}
            <div>
              <span className="p-2 bg-primary-100 text-primary-600">
                50% off
              </span>
            </div>
          </div>
