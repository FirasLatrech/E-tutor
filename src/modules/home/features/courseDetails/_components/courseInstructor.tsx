...
export const CourseInstructor = (props: Props) => {
  return (
    <div className="pt-6 w-[70%] flex flex-col gap-8 h-full pb-6">
      <div className="flex flex-col items-start justify-between gap-5">
        ...
        <div className="w-full">
          <div className="border border-gray-100 h-[238px] w-full p-3 flex gap-4">
            <div className="w-[30%]">
              <img
                src={InstructorImage}
                alt=""
            ...
            <div className="flex flex-col gap-4 w-[70%]">
              ...
              <div className=" text-[14px] font-[300] text-gray-700 ">
                ...
                fired from his own startup. He decided to work on his dream: be
                his own boss, travel the world, only do the work he enjoyed...
